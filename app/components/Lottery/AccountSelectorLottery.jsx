...
class AccountSelectorLottery extends React.Component {
    static propTypes = {
...
AccountSelectorLottery = BindToChainState(AccountSelectorLottery);

AccountSelectorLottery = connect(
...
export default AccountSelectorLottery;
