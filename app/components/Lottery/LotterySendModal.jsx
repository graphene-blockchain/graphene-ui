...
import AccountSelectorLottery from "./AccountSelectorLottery";
...
class LotterySendModal extends SendModal {
    constructor(props) {
        super(props);
    }
...
class LotterySendModalConnectWrapper extends React.Component {
    render() {
        return (
            <LotterySendModal {...this.props} ref={this.props.refCallback} />
        );
    }
}

LotterySendModalConnectWrapper = connect(
    LotterySendModalConnectWrapper,
    {
        listenTo() {
            return [AccountStore];
        },
...
export default LotterySendModalConnectWrapper;
